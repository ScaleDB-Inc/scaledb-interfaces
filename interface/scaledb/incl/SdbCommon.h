...
{
		char stringType;								// the character A - designates analytic string and C designates columns projection list (select columns from table).
...
#define SIZE_INFO_COLUMN_TRANSFER (2 *sizeof(SDB_UInt16))	// in a pushdown process, a range key that lists columns - the size of information added to every column
...
#define METAINFO_INCONSISTENT_MAPPED_FIELD 	1038
#define METAINFO_ATTEMPT_TRUNCATE_WITH_REFERENCED_DATA 1039
#define METAINFO_ATTEMPT_TRUNCATE_WITH_CHILD_USED 1040
#define METAINFO_ATTEMPT_TRUNCATE_WITH_UNCOMMITED_DATA 1041
#define METAINFO_GET_MEMORY_FAILED 1042
#define METAINFO_ATTEMPT_CLOSE_WITH_CHILDREN 1043
#define METAINFO_TOO_MANY_TABLES_DEFINED 1044
