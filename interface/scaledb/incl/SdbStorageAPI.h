...
char* SDBstat_getMonitorStatistics(unsigned short userId);
...
long long SDBRowsInRange( unsigned int userId, unsigned short queryMgrId ,unsigned short dbId, unsigned short tableId, unsigned short partitionId, unsigned int indexId,
						  unsigned char *minKey, SDBKeyTemplate& minKeyTemplate, SdbKeySearchDirection minkeyDirection,
						  unsigned char *maxKey, SDBKeyTemplate& maxKeyTemplate, SdbKeySearchDirection maxkeyDirection );
